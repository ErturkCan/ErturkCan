...
Rebuild the SVG assets with `python scripts/build_assets.py`. Convert the two `assets/vision-*.svg` files to PNG for GitHub using Sharp or another SVG renderer; these embed the demo image. All other cards use SVG directly.
